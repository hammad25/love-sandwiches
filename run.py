...
def get_sales_data():
    ...
    Run a while loop to collect a valid string of 6 numbers seperated by a commas. 
...
def get_last_5_entires_sales():
    """
    Collect collumsn of data from sales worksheet, collecting the last 5 entries
